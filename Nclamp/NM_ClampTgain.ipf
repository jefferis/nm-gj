...
Function /S ClampTgainInstrumentList()
	...
	return "Axopatch200B;Dagan3900A;AM2400"
...
Function ClampTgainConfigEditOld(config)
	...
	Prompt instr, "telegraphed instrument:", popup "Axopatch200B;Dagan3900A;AM2400"
...
Function MyTelegraphGain(tgain, defaultGain, instrument)
	...
	strswitch(instrument)
		...
		case "AM2400":
			...
			// V / pA or V/mV?  Yes
			// Does this in turn mean that mV and pA are the natural units of nclamp/neuromatic? Yes ...
			// Gain tables (as implemented in TGainAxo200B/TGainAM2400)
			// usually have units of mV/pA or mV/mV; however nclamp quite reasonably 
			// wants them in V/pA or V/mV so that is what the scale factor is about
			scale = 0.001 // V / mV 
			break
		default:
			return defaultGain
